...
"  --clist=PATH|-S PATH         Class list. Required.\n"
"  --hout=PATH|-H PATH          Output header. Default <libname>-diag.h.\n"
"  --cout=PATH|-C PATH          Output source. Default <libname>-diag.c.\n"
            ...
            int symlen)
{
    ...
    fprintf(houtfp, "#include <stdint.h>\n");
    ...
    fprintf(houtfp, "#ifdef HAVE_CONFIG_H\n");
    fprintf(houtfp, "#include \"config.h\"\n");
    fprintf(houtfp, "#ifdef HAVE_ABORT2\n");
    fprintf(houtfp, "#define xabort(m) do {\\\n");
    fprintf(houtfp, "    void *__xabort_argv[] = {(char *)__func__, (void *)(intptr_t)__LINE__};\\\n");
    fprintf(houtfp, "    abort2(m \" in \" __FILE__\": name, line = \",\\\n");
    fprintf(houtfp, "            countof(__xabort_argv), __xabort_argv);\\\n");
    fprintf(houtfp, "} while (0)\n");
    fprintf(houtfp, "#else // HAVE_ABORT2\n");
    fprintf(houtfp, "#define xabort(m) abort()\n");
    fprintf(houtfp, "#endif // HAVE_ABORT2\n");
    fprintf(houtfp, "#else // HAVE_CONFIG_H\n");
    fprintf(houtfp, "#define xabort(m) abort()\n");
    fprintf(houtfp, "#endif // HAVE_CONFIG_H\n");
    fprintf(houtfp, "#define FFAIL(m) xabort(m)\n");
